...
filenames <-
  list.files(
    "/Users/mariannachimienti/MarieCurie/Adelie_2019_2020EM", #107
  #      "/Users/mariannachimienti/MarieCurie/Adelie_2018_2019EM", #53
    pattern = "*.csv",
    full.names = TRUE
  )
...
nInd<-26 ### look at the total numbers of individuals, sample same n of individuals per season. 
...
trainingDF_Adelie20192020<-trainingDF
...
trainingDF_Adelie20182019<-trainingDF

trainingDF<-rbind(trainingDF_Adelie20182019,trainingDF_Adelie20192020)

write.csv(trainingDF, "/Users/mariannachimienti/MarieCurie/TrainingAdelie_MixSeason.csv", row.names = FALSE)
...
save.image(file="/Users/mariannachimienti/MarieCurie/RF_Results/RF_Adelie2019_MixSeasons.RData")
...
TimeBudget_EM<-data.frame(NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA)
TimeBudget_RF<-data.frame(NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA)

for (TripID in 14:nrow(filenamesPred)) {#nrow(filenamesPred)
  ...
  TimeBudget_EM[TripID,12]<-as.character("EM")
  ...
  TimeBudget_RF[TripID,12]<-as.character("RF")
...
colnames(TimeBudget_EM)<-c("Preen/highFlap_L","Walk" , "Swim/Porpoise","Preen/highFlap_W", "Rest" , "Hunting", "Ascending",     
                           "Swimming","Descending","Stand" ,"LieDown","Method" )
...
write.csv(AccuracyDF, "/Users/mariannachimienti/MarieCurie/AccuracyDFAdelie2018_2019_MixInTraining2.csv", row.names = FALSE)
write.csv(AllBudgets, "/Users/mariannachimienti/MarieCurie/AllBudgetsAdelie2018_2019_MixInTraining2.csv", row.names = FALSE)
quit(save="no")


AccuracyDF1<-fread("/Users/mariannachimienti/MarieCurie/AccuracyDFAdelie2018_2019_MixInTraining1.csv",header=TRUE)
AccuracyDF2<-fread("/Users/mariannachimienti/MarieCurie/AccuracyDFAdelie2018_2019_MixInTraining2.csv",header=TRUE)

AccuracyDF<-rbind(AccuracyDF1,AccuracyDF2)
...
AllBudgetsDF1<-fread("/Users/mariannachimienti/MarieCurie/AllBudgetsAdelie2018_2019_MixInTraining1.csv",header=TRUE)
AllBudgetsDF2<-fread("/Users/mariannachimienti/MarieCurie/AllBudgetsAdelie2018_2019_MixInTraining2.csv",header=TRUE)

AllBudgetsDF<-rbind(AllBudgetsDF1,AllBudgetsDF2)
...
write.csv(AccuracyDF, "/Users/mariannachimienti/MarieCurie/RF_Results/AccuracyDFAdelie2018_2019_MixInTraining.csv", row.names = FALSE)
write.csv(AllBudgetsDF, "/Users/mariannachimienti/MarieCurie/RF_Results/AllBudgetsAdelie2018_2019_MixInTraining.csv", row.names = FALSE)
# 
# # Basic barplot
...
for (TripID in 1:nrow(filenamesPred)) {#nrow(filenamesPred)
...
write.csv(AccuracyDF, "/Users/mariannachimienti/MarieCurie/AccuracyDFAdelie2018_2019_MixNotInTraining.csv", row.names = FALSE)
write.csv(AllBudgets, "/Users/mariannachimienti/MarieCurie/AllBudgetsAdelie2018_2019_MixNotInTraining.csv", row.names = FALSE)
quit(save="no")


# AccuracyDF1<-fread("/Users/mariannachimienti/MarieCurie/AccuracyDFAdelie2019_2020_MixNotInTraining_1.csv",header=TRUE)
# AccuracyDF2<-fread("/Users/mariannachimienti/MarieCurie/AccuracyDFAdelie2019_2020_MixNotInTraining_2.csv",header=TRUE)
# 
# AccuracyDF<-rbind(AccuracyDF1,AccuracyDF2)
# AccuracyDF<-AccuracyDF[which(!is.na(AccuracyDF$Accuracy))]
# length(unique(AccuracyDF$ID_Ind))
...
# 
# 
# AllBudgetsDF1<-fread("/Users/mariannachimienti/MarieCurie/AllBudgetsAdelie2019_2020_MixNotInTraining_1.csv",header=TRUE)
# AllBudgetsDF2<-fread("/Users/mariannachimienti/MarieCurie/AllBudgetsAdelie2019_2020_MixNotInTraining_2.csv",header=TRUE)
# 
# AllBudgetsDF<-rbind(AllBudgetsDF1,AllBudgetsDF2)
# AllBudgetsDF<-AllBudgetsDF[which(!is.na(AllBudgetsDF$Method))]
# 
...
# 
# 
# write.csv(AccuracyDF, "/Users/mariannachimienti/MarieCurie/RF_Results/AccuracyDFAdelie2019_2020_MixNotInTraining.csv", row.names = FALSE)
# write.csv(AllBudgetsDF, "/Users/mariannachimienti/MarieCurie/RF_Results/AllBudgetsAdelie2019_2020_MixNotInTraining.csv", row.names = FALSE)
# 
